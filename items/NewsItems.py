...
#新浪新闻的内存过滤。
class SinaNewsItemLoader(ItemLoader):
    default_item_class = SinaNewsItem
    ...
    publish_time_in = MapCompose(fo.removeBlankStr,fo.getSinaPublishTime)
